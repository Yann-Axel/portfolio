...
const roles = ["AI Developer", "Computer Vision Engineer", "Multi-Agent Systems Builder", "ML Practitioner"];
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        >
          Je construis des systèmes intelligents — de la reconnaissance faciale
          aux agents AI autonomes — avec Python, TensorFlow et les frameworks
          multi-agents modernes.
        </motion.p>
