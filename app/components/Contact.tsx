...
export default function Contact() {
  ...
  const email = "kouaettiendatascience@gmail.com";
  ...
  const socials = [
    {
      label: "GitHub",
      href: "https://github.com/Yann-Axel",
      icon: (
    ...
    {
      label: "LinkedIn",
      href: "https://www.linkedin.com/in/ettien-yann-axel-koua-b52ba5252/",
      icon: (
        <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
    ...
    >
      <div style={{ maxWidth: "700px", margin: "0 auto", textAlign: "center" }}>
        ...
        >
          ...
          >
            ...
            >
              <svg width="20" height="20" fill="none" stroke="#06b6d4" strokeWidth="2" viewBox="0 0 24 24">
                <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.77 12a19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 3.68 1.18h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L7.91 8.89a16 16 0 0 0 6.07 6.07l1.27-1.27a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7a2 2 0 0 1 1.72 2.03z" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
              <span style={{ color: "#f1f5f9", fontWeight: 500, fontSize: "0.95rem" }}>+225 07 16 36 91 74</span>
            </a>
          </div>
          ...
          <form
            action="https://formsubmit.co/kouaettiendatascience@gmail.com"
            method="POST"
            style={{ width: "100%", maxWidth: "480px", margin: "0 auto", display: "flex", flexDirection: "column", gap: "0.9rem" }}
          >
            <input type="hidden" name="_captcha" value="false" />
            <input type="hidden" name="_subject" value="Message depuis le portfolio — KOUA ETTIEN YANN-AXEL" />
